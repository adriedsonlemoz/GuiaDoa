...
## 1.0.102 — GitHub, Android e produção cloud mais consistentes

- GitHub: 3 cards por linha no mobile corrigidos também na regra global do admin.
- Visão geral volta a buscar/carregar o README ao abrir a seção.
- Baixar projeto e Publicar deixam de competir no mesmo cabeçalho; Publicar permanece na Central e abre o Wizard próprio.
- Workflows ganham ações mobile mais compactas e estados em português.
- Android: Capacitor/tar compatibilizados em 6.2.1 e Node 22 no workflow.
- Workflow usa a versão real do package.json no Vite.
- Render: trust proxy automático em ambiente gerenciado e diagnóstico ignora deploy antigo desativado quando o atual está saudável.
- Login cloud: cookie-probe sem 401 intencional; fallback Bearer continua disponível.
- Versão sincronizada em 1.0.102.
