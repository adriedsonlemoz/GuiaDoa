...
function garantirModalCampanha() {
  ...
  modal.innerHTML = `<div class="modal mc-modal"><div class="modal-header"><h3 id="mc-title">Novo registro</h3><button class="modal-close" onclick="fecharModal('modal-campanha')">✕</button></div>
    <div class="modal-body">
      ...
      <div class="mc-editor-block"><div class="mc-editor-head"><strong>◇ Recompensas possíveis</strong><button class="btn btn-ghost btn-sm" type="button" onclick="mcAddReward()">＋ Recompensa</button></div><div id="mc-rewards"></div><p class="admin-help-copy">Se o nome ainda não foi confirmado no jogo, deixe-o vazio e use um símbolo estável (R1, R2…). A imagem pode apontar para /assets/items/... e a quantidade pode ficar vazia quando o drop varia.</p></div>
