// Dados padrão canônicos de edifícios.
export const EDIFICIOS_META = {
  Casa:           { nome: 'Casa', icone: '🏠', tag: 'Pop.',    ordem: 0, descricao: 'Aumenta a população máxima da cidade, essencial para recrutar e sustentar tropas.' },
  Fazenda:        { nome: 'Fazenda', icone: '🌾', tag: 'Alim.',   ordem: 1, descricao: 'Produz alimento continuamente para sustentar tropas e o crescimento da cidade.' },
  FazendaPerolas: { nome: 'Fazenda de Pérolas', icone: '🔮', tag: 'Pérolas', ordem: 2, descricao: 'Produz pérolas valiosas usadas em pesquisas e negociações avançadas.' },
  FonteDaCura:    { nome: 'Fonte da Cura', icone: '💧', tag: 'Cura',    ordem: 3, descricao: 'Aumenta o limite de tropas que podem se curar simultaneamente no hospital.' },
  PontoDeReuniao: { nome: 'Ponto de Reunião', icone: '⚔️', tag: 'Marcha',  ordem: 4, descricao: 'Aumenta o limite de marchas e a quantidade de tropas enviadas por vez.' },
  Sentinela:      { nome: 'Sentinela', icone: '👁️', tag: 'Def.',    ordem: 5, descricao: 'Revela informações progressivas sobre ataques inimigos conforme sobe de nível.' },
  Fortaleza:      { nome: 'Fortaleza', icone: '🏰', tag: 'Fort.',   ordem: 6, descricao: 'Expande territórios, pontos de reforço e áreas disponíveis da cidade.' },
  Mina:           { nome: 'Mina', icone: '⛏️', tag: 'Ouro',    ordem: 7, descricao: 'Extrai ouro continuamente para financiar pesquisas e construções avançadas.' },
  Pedra:          { nome: 'Pedreira', icone: '🪨', tag: 'Pedra',   ordem: 8, descricao: 'Extrai pedra continuamente, recurso essencial para obras e aprimoramentos.' },
  Serraria:       { nome: 'Serraria', icone: '🌲', tag: 'Madeira', ordem: 9, descricao: 'Produz madeira continuamente, necessária para diversas construções da cidade.' },
  Fabrica:        { nome: 'Fábrica', icone: '🏭', tag: 'Prod.',   ordem: 10, descricao: 'Permite treinar unidades de guerra avançadas à medida que sobe de nível.' },
  Viveiro:        { nome: 'Viveiro', icone: '🥚', tag: 'Dragão',  ordem: 11, descricao: 'Acelera o treinamento de dragões e desbloqueia novas espécies raras.' },
  Guarnicao:      { nome: 'Guarnição', icone: '⚔️', tag: 'Treino', ordem: 12, descricao: 'Permite treinar tropas. Mais Guarnições aumentam a capacidade e reduzem o tempo de treinamento.' },
  Forja:          { nome: 'Forja', icone: '🔨', tag: 'Forja', ordem: 13, descricao: 'Estrutura de metalurgia usada para liberar e apoiar unidades e melhorias avançadas.' },
  Cofre:          { nome: 'Cofre', icone: '🔐', tag: 'Proteção', ordem: 14, descricao: 'Protege parte dos recursos armazenados contra perdas e saques.' },
  Teatro:         { nome: 'Teatro', icone: '🎭', tag: 'Moral', ordem: 15, descricao: 'Aumenta a felicidade da população e ocupa um espaço normal da cidade.' },
  CentroDeCiencia:{ nome: 'Centro de Ciência', icone: '🔬', tag: 'Pesquisa', ordem: 16, descricao: 'Permite pesquisar tecnologias que fortalecem a cidade, tropas e produção.' },
  FossoDeFogo:    { nome: 'Fosso de Fogo', icone: '🔥', tag: 'Enxofre', ordem: 17, descricao: 'Produz Enxofre e só pode ser construído nos espaços exclusivos da Ilha de Fogo.' },
  MinaDeGeodos:   { nome: 'Mina de Geodos', icone: '💎', tag: 'Geodos', ordem: 18, descricao: 'Produz Geodos e só pode ser construída nos espaços exclusivos da Ilha da Terra.' },
  ViveiroSementes:{ nome: 'Viveiro de Sementes', icone: '🌱', tag: 'Sementes', ordem: 19, descricao: 'Produz Sementes e só pode ser construído nos espaços exclusivos da Ilha Belladonna.' },
};

export const EDIFICIOS_COLUNAS = {
  ...
  Guarnicao:      [{ key: 'desc', label: 'Efeito', tipo: 'text' }],
  Forja:          [{ key: 'desc', label: 'Efeito', tipo: 'text' }],
  Cofre:          [{ key: 'desc', label: 'Efeito', tipo: 'text' }],
  Teatro:         [{ key: 'desc', label: 'Efeito', tipo: 'text' }],
  CentroDeCiencia:[{ key: 'desc', label: 'Efeito', tipo: 'text' }],
  FossoDeFogo:    [{ key: 'pop', label: 'Pop.', tipo: 'number' }, { key: 'prodHora', label: 'Prod./h', tipo: 'number' }, { key: 'cap', label: 'Cap. Máx.', tipo: 'number' }],
  MinaDeGeodos:   [{ key: 'pop', label: 'Pop.', tipo: 'number' }, { key: 'prodHora', label: 'Prod./h', tipo: 'number' }, { key: 'cap', label: 'Cap. Máx.', tipo: 'number' }],
  ViveiroSementes:[{ key: 'pop', label: 'Pop.', tipo: 'number' }, { key: 'prodHora', label: 'Prod./h', tipo: 'number' }, { key: 'cap', label: 'Cap. Máx.', tipo: 'number' }],
};

export const EDIFICIOS_NIVEIS = {
  Casa: [
  ...
  Guarnicao: [
    { nivel: 1, desc: 'Permite treinar tropas e inicia a fila de treinamento.' },
    { nivel: 5, desc: 'Aumenta a capacidade de treinamento e reduz o tempo de treino.' },
    { nivel: 10, desc: 'Libera tropas melhores e melhora a velocidade de treinamento.' },
    { nivel: 18, desc: 'Atende requisitos de tropas avançadas e mantém bônus de treinamento.' },
    { nivel: 30, desc: 'Nível avançado de Guarnição para filas e treinamentos de alto nível.' },
  ],
  Forja: [{ nivel: 1, desc: 'Estrutura de metalurgia ativa.' }],
  Cofre: [{ nivel: 1, desc: 'Protege recursos armazenados.' }],
  Teatro: [{ nivel: 1, desc: 'Aumenta a felicidade da população.' }],
  CentroDeCiencia: [{ nivel: 1, desc: 'Libera pesquisas básicas.' }, { nivel: 12, desc: 'Centro de Ciência avançado para pesquisas de níveis superiores.' }],
  Fabrica: [
