export const detectarIntencao = (pergunta) => {
  ...
  if (/edifício|edificio|fazenda|casa|mina|pedreira|serraria|fortaleza|fonte|sentinela|viveiro|fábrica|pérola|building|farm|house|mine|quarry|sawmill|fortress|spring|sentinel|nursery|factory|pearl/.test(p)) return 'edificio';
