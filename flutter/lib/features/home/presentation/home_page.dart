          ...
          child: Ink(
            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    Container(
                      ...
                      child: Center(child: Text(tool.emoji, style: const TextStyle(fontSize: 21))),
                    ),
                    const Spacer(),
                ...
                const SizedBox(height: 2),
                Text(strings.t(tool.subtitleKey), maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: tool.migrated ? GuiaColors.ink2 : GuiaColors.muted, fontSize: 10.5)),
              ],
            ),
          ),
        ),
