...
const ProfileField = ({ label, hint, children }) => (
  <div style={{ marginBottom:14 }}>
    <div style={{ display:'flex', alignItems:'baseline', gap:6, marginBottom:6 }}>
      ...
      {hint && <span style={{ fontFamily:"system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif", fontWeight:600, fontSize:'.6rem', color:C.TEXT_FAINT }}>({hint})</span>}
    </div>
    {children}
  </div>
);
