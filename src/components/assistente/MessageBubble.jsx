    ...
    <div style={{ display:'flex', justifyContent: isUser ? 'flex-end' : 'flex-start', marginBottom: 10 }}>
      ...
      <div style={{ maxWidth: '78%' }}>
        <div style={{
          ...
          <div style={{
            fontFamily:'"Nunito",sans-serif', fontWeight:600, fontSize:'0.76rem', lineHeight:1.55,
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent: isUser ? 'flex-end' : 'flex-start', gap: 8, marginTop: 2 }}>
          <p style={{
            fontFamily:'"Nunito",sans-serif', fontWeight:600, fontSize:'0.55rem', color:C.TEXT_FAINT, margin:0,
          }}>{msg.hora}</p>
  ...
  return (
    <div style={{ display:'flex', justifyContent:'flex-start', marginBottom:10 }}>
      ...
      <div style={{
        ...
        {mensagem && (
          <span style={{ fontFamily:'"Nunito",sans-serif', fontWeight:600, fontSize:'0.65rem', color:C.TEXT_MUTED }}>
            {mensagem}
          </span>
        )}
      </div>
