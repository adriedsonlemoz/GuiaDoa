    ...
    >
      ...
      >
        ...
        <div className="text-right shrink-0">
          ...
          <p className="font-nunito text-[0.55rem] tracking-widest mb-1 m-0" style={{ color: C.TEXT_FAINT }}>{t('common.power_short')}</p>
          <span
        ...
        <div style={{ borderTop: `1px solid ${C.BORDER_SOFT}` }}>
          ...
          <div className="px-3 pt-2.5 pb-1">
            ...
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <span className="font-nunito font-bold text-[0.68rem] tracking-widest" style={{ color: C.TEXT_MUTED }}>{t('common.attributes').toUpperCase()}</span>
            ...
            <div className="grid grid-cols-2 gap-x-3.5">
              {ATRIBUTOS.map(attr => (
                <StatRow key={attr.id} icon={attr.icon} label={t(attr.labelKey)}
          ...
          <div className="px-3 pb-2.5 flex gap-1.5">
            {[{ icon: '📋', title: t('troops.requirements') }, { icon: '🔮', title: t('troops.amulets') }].map(sec => (
              <div key={sec.title}
              ...
              >
                ...
                <p className="font-nunito italic text-[0.68rem] m-0 mt-0.5" style={{ color: C.TEXT_FAINT }}>{t('common.coming_soon')}</p>
              </div>
            ))}
          </div>
          ...
          >
            <p className="font-nunito font-bold text-[0.68rem] tracking-widest mb-1.5 m-0" style={{ color: C.TEXT_MUTED }}>
              {t('troops.owned').toUpperCase()}
            </p>
            <div className="flex gap-1.5">
              <input
                className="tw-input text-center flex-1"
                placeholder="0"
                value={quantidade ? quantidade.toLocaleString(locale) : ''}
